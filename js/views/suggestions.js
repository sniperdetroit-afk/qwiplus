  ...
  ">
    <div style="max-width:480px;margin:0 auto;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:32px;">
        <button id="backSuggestions" style="
          background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);
          font-size:20px;cursor:pointer;color:#F5F7FA;padding:8px 14px;border-radius:12px;
        ">←</button>
        <h2 style="margin:0;font-size:24px;font-weight:800;color:#F5F7FA;">💡 Sugerencias</h2>
      </div>
      <p style="color:#9CA3AF;font-size:15px;margin-bottom:20px;">
        ¿Tienes alguna idea para mejorar Qwiplus? ¡Cuéntanos!
      </p>
      ...
      "></textarea>
      <button id="sendSuggestion" style="
